...
3. 设置游戏路径（可选）
> 如果你使用官方启动器等非集成环境，请手动将`GAME DIRECTORY`指向该整合包的安装目录
4. 启动游戏

## 安装服务端
> 如果你仅在**单人游戏**中联机，则**不需要**安装服务端
...
> If you are using a non-integrated environment like the Official Launcher, manually point the `GAME DIRECTORY` to the installation folder of this modpack.
4. Launch game

## Install Server
> If you are playing in **Singleplayer** (including LAN), a separate server installation is **NOT required**.

1. Download server library files
> |1.20.1 forge|1.21.1 neoforge|
> |---|---|
